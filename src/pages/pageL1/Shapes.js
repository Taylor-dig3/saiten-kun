...
export function Lights() {
  return (
    <>
      ...
      <spotLight color="#868edb" position={[15, 10, -2]} intensity={2} />
      <spotLight color="#868edb" position={[15, 10, 5]} intensity={1} />
      <spotLight color="#0e07db" position={[5, -10, 5]} intensity={0.8} />
    </>
  );
}
